    ...
    <div className="px-6 py-16 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-14">
          {/* Card 1 */}
          <div className="bg-gray-50 p-6 rounded-2xl shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-[#0492c2] mb-5">Additional Safety Tips</h2>
        ...
        {/* Before / During / After */}
        <div>
          <h2 className="text-2xl font-bold text-[#0492c2] mb-4">
          ...
          <h3 className="text-xl font-semibold text-[#0492c2] mb-3">Before</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-8">
            ...
            <li>Learn how to shut off gas, water and electricity in case the lines are damaged.</li>
          ...
          <h3 className="text-xl font-semibold text-[#0492c2] mb-3">During</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-8">
            ...
            <li>Stay in the vehicle if downed power lines have fallen across it. Do not touch metal. Wait for help.</li>
            <li>If you have to leave your vehicle, move to an open area quickly.</li>
          </ul>

          <h3 className="text-xl font-semibold text-[#0492c2] mb-3">After</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700 mb-8">
            ...
            <li>Turn on the radio and listen for emergency broadcasts/announcements, news reports, and instructions.</li>
